...
import { samplePackages } from "./TravelList";
import { useState } from "react";

export function TravelToursDetails() {
    ...
    <div className="max-w-5xl mx-auto px-4 py-10 space-y-16">
      ...
      <div className="flex flex-col sm:flex-row gap-6 items-center bg-white rounded-lg shadow-lg p-6 opacity-0 animate-slideInRight">
        <div className="sm:w-2/3 flex flex-col justify-center">
          ...
          <p className="text-gray-700 leading-relaxed whitespace-pre-line">{tour.FamousPlaces}</p>
        </div>
        <div className="sm:w-1/3 w-full">
          <img
            src={tour.images[2]}
